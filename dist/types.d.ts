...
export type ConsentSource = 'booking_widget' | 'back_office' | 'follower_form' | 'ios_flight_follower' | 'import' | 'inbound_keyword';
...
export interface SmsStore {
    ...
    incrementCounters(orgId: string, day: string): Promise<{
        org: number;
        global: number;
    }>;
